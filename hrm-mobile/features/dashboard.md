...
- 🟢 Sebelum clock in: tombol **"Clock In"** (warna hijau)
- 🔴 Setelah clock in: berubah jadi **"Clock Out"** (merah)
- ⏱️ Menampilkan durasi kerja hari ini (misal: "5j 32m")
...
<table data-view="cards">
  ...
  <tbody>
    <tr><td>📋 <strong>Absensi</strong><br>Detail & koreksi absensi</td><td>🏖️ <strong>Cuti</strong><br>Saldo & pengajuan cuti</td></tr>
    <tr><td>⏰ <strong>Lembur</strong><br>Pengajuan lembur</td><td>🔄 <strong>Shift</strong><br>Request perubahan shift</td></tr>
    <tr><td>💰 <strong>Slip Gaji</strong><br>Lihat & download</td><td>⚠️ <strong>Peringatan</strong><br>Surat peringatan</td></tr>
    ...
    <tr><td>👥 <strong>Organisasi</strong><br>Direktori karyawan</td><td>✏️ <strong>Profile Change</strong><br>Update data profil</td></tr>
  </tbody>
</table>
